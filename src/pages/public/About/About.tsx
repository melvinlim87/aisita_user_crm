...
import { Target, Users, Award, Rocket, Brain, Code, Globe, ArrowRight } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-[#DAA520] mb-8">
      ...
      {/* Vision & Values */}
      <section className="py-20 bg-[#111111]/60">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-[#0b0b0e] rounded-lg p-8 glow-border text-center border border-[#C0C0C0]">
                <div className={`w-16 h-16 rounded-xl ${META_GRADIENT} flex items-center justify-center mx-auto mb-6`}>
                  {value.icon}
                </div>
                <h3 className="text-xl font-semibold mb-3 metallic-text">{value.title}</h3>
                <p className="text-[#DAA520]">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-[#DAA520]">
                ...
                <div key={index} className="flex items-start gap-6">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-sm font-medium text-[#DAA520] bg-[#0b0b0e] px-2 py-1 rounded border border-[#C0C0C0]">
                        {milestone.year}
                      </span>
                      <h3 className="text-xl font-semibold metallic-text">{milestone.title}</h3>
                    </div>
                    <p className="text-[#DAA520]">{milestone.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="bg-[#0b0b0e] rounded-lg overflow-hidden glow-border border border-[#C0C0C0]">
                ...
                <div className="p-6">
                  <h3 className="text-lg font-semibold mb-1 metallic-text">{member.name}</h3>
                  <p className="text-[#DAA520] text-sm mb-3">{member.role}</p>
                  <p className="text-[#DAA520] text-sm">{member.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto rounded-2xl bg-[#0b0b0e] overflow-hidden glow-border border border-[#C0C0C0]">
            <div className="relative p-8 md:p-12">
              <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-transparent via-[#111111]/80 to-[#111111]"></div>
              </div>
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-lg text-[#DAA520] mb-8 max-w-2xl mx-auto">
